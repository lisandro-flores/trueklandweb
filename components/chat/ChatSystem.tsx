...
export default function ChatSystem({ exchangeId, otherUserId, otherUserName }: ChatSystemProps) {
  ...
  return (
    <Card className="h-96 flex flex-col glass-effect border-0">
                ...
                <div key={message.id} className="space-y-2">
                  ...
                  {showDate && (
                    <div className="text-center">
                      <span className="glass-effect text-gray-600 text-xs px-3 py-1 rounded-full border border-white/30">
                  ...
                  <div className={`flex ${isOwn ? 'justify-end' : 'justify-start'}`}>
                    <div className={`max-w-xs lg:max-w-md px-4 py-2 rounded-2xl ${
                      isOwn 
                        ? 'bg-gradient-to-r from-[#91f2b3] to-[#fcf326] text-gray-800 shadow-lg' 
